...
function authenticate($u) {
  ...
  if (!isset($u[$_SERVER['PHP_AUTH_USER']]) || $u[$_SERVER['PHP_AUTH_USER']]!=$_SERVER['PHP_AUTH_PW']) die("Invalid Password");
...
$style = <<<END_OF_STYLE
body { margin: 8px; font-family:mono; font-size:14px; color: #c1b9b9; background:#333; }a{ color: #f4ff95; } a:hover{ color: #daec3a; } a.copy{ color: #5bec37ed; text-decoration:none; } #inpt{font-family:mono; font-size:14px; color: white; padding:5px 10px; margin:0; border:0; width:40em;background:#333;}#inpt:focus{outline:0}#basename a{background:#333;color:#fff;padding:5px 10px}
END_OF_STYLE;
...
{ global $home;
  ...
  echo <<<END_OF_HTML
<html><head>
<title>Shell Buddy</title>
<link rel="shortcut icon" href="data:image/png;base64,"/>
<style>
$style
</style>
...
<form style="display:inline; padding:0; margin:0;" onsubmit="return onenter();">$prompt<input id="inpt" type="text" name="command" autocomplete="off"\></form>
<div>$suggestions</div>
</body></html>
END_OF_HTML;
}
